        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="productos.php">Herrramientas</a></li>
...
<div class="row flex-lg-row-reverse align-items-center g-5 py-5 mx-5">
   <div class="col-10 col-sm-8 col-lg-6"> 
    <img src="img/ferre3.jpg" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy"> </div> 
    <div class="col-lg-6"> 
